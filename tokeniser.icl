...
commandMapping =: // TODO: make this a function in the above ^
	...
	,(Operator (Unary_N_S (fromOneToMiddle)))//(Operator (Range_FromMiddleToZero))
	...
	,(Operator (Unary_N_S (fromMiddleToZero)))//(Operator (Range_FromMiddleAvoidZero))
	...
	,(Operator (Binary_NN_S False (convToBase)))//(Operator (Math_ConvertToBase))
	...
	,(Operator (Unary_S_N (numAverage)))//PlaceHolder//(Operator (Unary_S_N (avg)))//(Operator (Math_Average))
	...
	,(Operator (Binary_SN_N (convFromBase)))//(Operator (Math_ConvertFromBase))
	...
	,(Operator (Binary_SS_S True (setExclusion)))//(Operator (Set_Union))
	...
	,(Operator (Binary_SS_N False (numContigSubsets)))
	,(Operator (Binary_SS_T False (splitContig)))
	...
	,(Operator (Unary_S_T (contigSubsets)))//(Operator (Set_Subsets))
