...
commandMapping =: // TODO: make this a function in the above ^
	...
	,(Operator (Binary_NN_E False (fromLeftStepRight)))//(Operator (Range_FromLeftStepRight))
	,(Operator (Binary_NN_N False (-)))//(Operator (Math_Subtraction))
	,(Operator (Unary_N_E (fromOneToMiddle)))//(Operator (Range_FromMiddleToZero))
	...
	,(Operator (Unary_N_E (fromMiddleToZero)))//(Operator (Range_FromMiddleAvoidZero))
	,(Operator (Binary_NN_E False (fromLeftTimesRight)))//(Operator (Range_FromLeftTimesRight))
	...
	,(Operator (Unary_M_M (takeStackFrom)))//PlaceHolder//(Stack (AdjustOffset))
	,(Literal (Alphabet Uppercase))
	,(Operator (Binary_NN_E False (convToBase)))//(Operator (Math_ConvertToBase))
	,(Operator (Unary_N_N (acos)))//(Operator (Math_ArcCoSine))
	,(Operator (Unary_E_E (mapMaybe S_uniques)))//PlaceHolder//(Operator (Unary_E_E (removeDup)))//(Stack (Uniques_Middle))
	...
	,(Operator (Unary_E_N (setMaximum)))//(Operator (Set_Maximum))
	,(Operator (Unary_N_N (justImag)))//(Operator (Math_ImaginaryPart))
	,(Operator (Unary_N_N (justReal)))//(Operator (Math_RealPart))
	,(Operator (Binary_EE_E False (antiFilter)))//(Operator (Set_AntiFilter))
	...
	,(Operator (Unary_E_N (isSorted)))//(Operator (Logic_IsOrdered))
	...
	,(Operator (Unary_E_N (numAverage)))//PlaceHolder//(Operator (Unary_E_N (avg)))//(Operator (Math_Average))
	...
	,(Operator (Binary_EN_N (convFromBase)))//(Operator (Math_ConvertFromBase))
	,(Operator (Unary_N_N (cos)))//(Operator (Math_CoSine))
	,(Operator (Unary_E_E (dupesMiddle)))//(Stack (Duplicates_Middle))
	...
	,(Operator (Unary_E_N (setMinimum)))//(Operator (Set_Minimum))
	,(Operator (Unary_N_N (imagUnit)))//(Operator (Math_ImaginaryUnit))
	,(Operator (Unary_M_M (complexSplit)))//(Operator (Math_ComplexSplit))
	,(Operator (Binary_EE_E False (setFilter)))//(Operator (Set_Filter))
	,(Operator (Unary_N_N (log10)))//(Operator (Math_Base10Logarithm))
	,(Operator (Binary_NN_N False (numCombin)))//(Operator (Math_Combinations))
	,(Operator (Unary_E_R (splitOnNewlines)))//(Operator (Chars_SplitOnNewlines))
	,(Operator (Unary_E_E (mapMaybe S_sort)))//(Operator (Unary_E_E (sort)))//(Operator (Set_MakeOrdered))
	,(Operator (Unary_N_E (primeFactors)))//(Operator (Math_PrimeFactors))
	,(Variable (History))
	...
	,(Operator (Binary_EE_E True (vectorTimes)))//(Operator (Vector_Multiplication))
	,(Operator (Binary_NN_N False (/)))//(Operator (Math_Division))
	,(Operator (Binary_EE_E True (vectorPlus)))//(Operator (Vector_Addition))
	,(Operator (Unary_E_E (vectorNegate)))//(Operator (Vector_Negation))
	...
	,(Operator (Binary_EE_E True (vectorOR)))//(Operator (Vector_Or))
	,(Operator (Binary_NN_N True (bitAND)))//(Operator (Bitwise_And))
	,(Operator (Binary_EE_E True (vectorAND)))//(Operator (Vector_And))
	...
	,(Operator (Binary_EE_E True (setIntersection)))//(Operator (Set_Intersection))
	,(Operator (Binary_EE_E True (setExclusion)))//(Operator (Set_Union))
	,(PlaceHolder)//(Operator (Set_Exclusion))
	,(Operator (Binary_NE_N (isElementOf)))//(Operator (Logic_ElementOf))
	,(Operator (Binary_EE_E False (vectorElementOf)))//(Operator (Vector_ElementOf))
	,(Operator (Binary_EE_E False (vectorLessThan)))//(Operator (Vector_LessThan))
	,(Operator (Binary_EE_E False (vectorGreaterThan)))//(Operator (Vector_GreaterThan))
	,(Operator (Binary_EE_E True (vectorIsEqual)))//(Operator (Vector_Equality))
	,(Operator (Binary_NN_N False (isLessOrEqual)))//(Operator (Logic_LessOrEqual))
	,(Operator (Binary_EE_E False (vectorLessOrEqual)))//(Operator (Vector_LessOrEqual))
	,(Operator (Binary_NN_N False (isGreaterOrEqual)))//(Operator (Logic_GreaterOrEqual))
	,(Operator (Binary_EE_E False (vectorGreaterOrEqual)))//(Operator (Vector_GreaterOrEqual))
	,(Operator (Binary_NN_N True (isNotEqual)))//(Operator (Logic_Inequality))
	,(Operator (Binary_EE_N True (isIdentical)))//(Operator (Logic_SetEquality))
	,(Operator (Binary_EE_N False (isProperSubsetOf)))//(Operator (Logic_SubsetNotEqual))
	,(Operator (Binary_EE_N False (isImproperSubsetOf)))//(Operator (Logic_SubsetOrEqual))
	,(Operator (Binary_EE_N False (isNotSubsetOf)))//(Operator (Logic_NotSubsetNorEqual))
	...
	,(Operator (Binary_NN_N False (bitLEFT)))//(Operator (Bitwise_LeftShift))
	,(Operator (Binary_NN_N False (bitRIGHT)))//(Operator (Bitwise_RightShift))
	...
	,(Operator (Unary_M_M (stackDelete Every)))//(Stack (Delete_All))
	...
	,(Operator (Binary_EE_N False (numContigSubsets)))
	,(Operator (Binary_EE_R False (splitContig)))
	...
	,(Operator (Unary_E_N (numProduct)))//(Operator (Math_Product))
	,(Operator (Unary_E_N (numSum)))//(Operator (Math_Sum))
	,(Operator (Unary_E_N (areAnyTrue)))//(Operator (Logic_Any))
	,(Operator (Unary_E_N (areAllTrue)))//(Operator (Logic_All))
	,(Operator (Set_PowerSet))
	,(Operator (Unary_E_R (contigSubsets)))//(Operator (Set_Subsets))
	...
	,(Control (Skip True))
	,(Control (Skip False))
	,(Operator (Unary_E_R (groupMiddle)))//(Stack (Group_Base))
	,(Literal (EmptySet))
